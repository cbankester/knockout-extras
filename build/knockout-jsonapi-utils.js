(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("knockout"), require("moment"));
	else if(typeof define === 'function' && define.amd)
		define(["knockout", "moment"], factory);
	else if(typeof exports === 'object')
		exports["KnockoutJsonApiUtils"] = factory(require("knockout"), require("moment"));
	else
		root["KnockoutJsonApiUtils"] = factory(root["ko"], root["moment"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _koExtenders = __webpack_require__(4);

	var _koExtenders2 = _interopRequireDefault(_koExtenders);

	var _koFormBase = __webpack_require__(10);

	var _koFormBase2 = _interopRequireDefault(_koFormBase);

	var _fraction = __webpack_require__(5);
	...
	var KnockoutJsonApiUtils = function () {
	  function KnockoutJsonApiUtils() {
	    _classCallCheck(this, KnockoutJsonApiUtils);
	  }

	  _createClass(KnockoutJsonApiUtils, null, [{
	    key: 'setupExtenders',
	    value: function setupExtenders() {
	      if (!extenders_assigned) {
	        Object.assign(_knockout2.default.extenders, _koExtenders2.default);
	    ...
	    get: function get() {
	      return _humanizeDuration2.default;
	    }
	  }]);
	...
	exports.default = KnockoutJsonApiUtils;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.httpJSON = exports.RequestError = undefined;
	...
	function create_observable(vm, attr_name, attr_val) {
	  return vm[attr_name] = (0, _knockout.observable)().extend({
	    postable: attr_name,
	...
	function init_relationship(vm, rel_name, rel_data) {
	  ...
	  var obs = vm[rel_name] || (vm[rel_name] = rel_data instanceof Array ? (0, _knockout.observableArray)([]) : (0, _knockout.observable)());

	  if (client_defined_relationship && client_defined_relationship.allow_destroy) vm['non_deleted_' + rel_name] = (0, _knockout.computed)(function () {
	...
	function build_relationship(vm, rel_name, rel_data, obs) {
	  ...
	  if (rel_data instanceof Array) {
	    ...
	    if (client_defined_relationship) {
	      ...
	      if (client_defined_relationship.class) {
	        var _klass = client_defined_relationship.class;
	        record = new _klass(vm, Object.assign({}, remapped));

	        if (_klass.prototype.doneLoading) done = record.doneLoading();
	      }
	    }
	    obs(record || remapped);
	  } else {
	    ...
	    if (client_defined_relationship) {
	      ...
	      if (client_defined_relationship.class) {
	        var _klass2 = client_defined_relationship.class;
	        var blank_value = client_defined_relationship.blank_value || {};

	        _record = new _klass2(vm, Object.assign({}, typeof blank_value === 'function' ? blank_value.call(vm) : blank_value));

	        if (_klass2.prototype.doneLoading) done = _record.doneLoading();
	      }
	    }
	    obs(_record || {});
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	function computedSanitizeProxy(target, sanitize_fn) {
	  var result = (0, _knockout.pureComputed)({
	    read: target,
	...
	*/
	...
	function typeObservableFunction(type) {
	  return { type: type, observable: (0, _knockout.observable)() };
	}
	...
	*/
	...
	function setupValidationObservables(target) {
	  ...
	  setupObservableDisposables(target);
	  target.errors = (0, _knockout.observableArray)([]);

	  // hasError: true if one of the validations on this observable fails
	  target.hasError = (0, _knockout.computed)(function () {
	  ...
	  target.validationMessage = (0, _knockout.computed)(function () {
	...
	*/
	...
	setupExtender('initial_value', function (target, init_val) {
	  ...
	  var initial_value_observable = (0, _knockout.observable)().extend({ notify: 'always' });
	  ...
	  if (target.initial_value) {
	    ...
	    if (~index) {
	      ...
	      var _target$disposables$s2 = _slicedToArray(_target$disposables$s, 1);
	  ...
	  target.initial_value = (0, _knockout.computed)({
	...
	*/
	...
	setupExtender('initial_length', function (target, initial_length) {
	  target.initial_length = (0, _knockout.observable)(initial_length);
	  return target;
	});
	...
	*/
	...
	setupExtender('unique', function (target, opts) {
	  ...
	  var mapped_array = (0, _knockout.computed)(function () {
	    return (0, _knockout.unwrap)(uniq_in).map(function (obj) {
	      return (0, _knockout.unwrap)(obj[attribute_name]);
	    });
	  });
	...
	setupExtender('numeric', function numeric(target, opts) {
	  ...
	  function sanitize(value) {
	    ...
	    if (out) {
	      ...
	      try {
	        is_rational && (out = new _fraction2.default(out));
	      } catch (e) {
	        if (e === 'Invalid Param') {
	...
	*/
	...
	function humanizeMilliseconds(millis, opts) {
	  ...
	  return (0, _humanizeDuration2.default)(millis, {
	    delimiter: delimiter || ' ',
	...
	*/
	...
	setupExtender('time', function time(target, opts) {
	  ...
	  function sanitize(val) {
	    return (0, _moment2.default)(val, format).format(format);
	  }
	...
	*/
	...
	setupExtender('watch_for_pending_changes', function (target) {
	  setupObservableDisposables(target);
	  if ('push' in target) {
	    target.no_changes_pending = (0, _knockout.computed)(function () {
	...
	*/
	...
	function _createInstance(klass, this_arg, args) {
	  return new (Function.prototype.bind.apply(klass, [null].concat([this_arg], _toConsumableArray(args.map(function (arg) {
	...
	setupExtender('pushable', function (target, opts) {
	  if ('push' in target) {
	    (function () {
	      ...
	      var set_inverse_of = _ref8.set_inverse_of;
	      ...
	      if (set_inverse_of) {
	        (function () {
	          var inverse_name = typeof set_inverse_of === 'string' ? set_inverse_of : 'inverse_of';
	          target.addNew = function addNew() {
	            return new Promise(function (resolve) {
	              var record = _createInstance(klass, this_arg, args);
	        ...
	        target.addNew = function addNew() {
	          return new Promise(function (resolve) {
	            return _pushAndResolve(target, _createInstance(klass, this_arg, args), resolve);
	          });
	        };
	      }
	    })();
	...
	*/
	...
	setupExtender('track_focus', function (target, opts) {
	  ...
	  target.has_focus = (0, _knockout.observable)(false);
	  if (track_has_had) {
	    (function () {
	      setupObservableDisposables(target);
	      target.has_had_focus = (0, _knockout.observable)(false);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _initKOFormVMFromJsonApiResponse(vm, response) {
	  ...
	  attribute_names.forEach(function (attribute_name) {
	    if (observable_attributes_blacklist.includes(attribute_name)) {
	      ...
	      vm.observables_list.push(json_api_utils.create_observable(vm, attribute_name, server_defined_attributes[attribute_name]));
	    }
	  });
	  ...
	  return Promise.all(relationship_names.map(function (key) {
	    return json_api_utils.init_relationship(vm, key, server_defined_relationships[key].data, client_defined_relationships);
	...
	function _sendRequests(requests) {
	  return json_api_utils.httpJSON.get(requests).catch(function (xhr) {
	...
	var KOFormBase = function () {
	  _createClass(KOFormBase, [{
	    ...
	    value: function handleOtherRequests(_responses) {
	    ...
	    value: function finalizeInit() {
	      ...
	      errorable.forEach(function (obs) {
	        if (obs.postable_name) _this2.errors[obs.postable_name] = _knockout2.default.computed(function () {
	          return obs.hasError() && obs.validationMessage() || null;
	        });else if (obs.errorable_observables) _this2.errors[obs.errorable_name] = _knockout2.default.computed(function () {
	          return obs.hasError() && obs.errors() || null;
	        });
	      });
	      this.numErrors = this.numErrors || _knockout2.default.computed(function () {
	        return errorable.reduce(function (total, obs) {
	          return total + (obs.hasError() ? obs.numErrors ? obs.numErrors() : 1 : 0);
	        }, 0);
	      });

	      this.is_valid = _knockout2.default.computed(function () {
	        return !_this2.numErrors();
	      }).extend({ notify: 'always' });

	      this.no_changes_pending = _knockout2.default.computed(function () {
	      ...
	      this.changes_pending = _knockout2.default.computed(function () {
	      ...
	      if (this.options.save_after_edit) {
	        (function () {
	          ...
	          var should_save = _knockout2.default.computed(function () {
	  ...
	  function KOFormBase() {
	    ...
	    Object.assign(this, {
	      loading: _knockout2.default.observable(true),
	      attempted: _knockout2.default.observable(false),
	      error_message: _knockout2.default.observable(null),
	      observables_list: [],
	      relationships: []
	    });
	  }
	  ...
	  _createClass(KOFormBase, [{
	    ...
	    value: function save() {
	      ...
	      return new Promise(function (resolve, reject) {
	        ...
	        json_api_utils.httpJSON[_this4.id ? 'patch' : 'post']({
	          url: _this4.url,
	          data: {
	            data: {
	              id: _this4.id,
	          ...
	          var record = json_api_utils.parse_json_api_response(response);
	          if (record) {
	            _this4.id = record.id;
	          ...
	          return reject(new json_api_utils.RequestError(xhr));
	        });
	      });
	    }
	  }, {
	    ...
	    value: function serialize() {
	      ...
	      this.observables_list.forEach(function (obs) {
	        ...
	        if (pname) json[pname] = val instanceof Date ? val.toISOString() : val;else if (nname) json[nname] = obs.initial_length ? val.map(function (v) {
	          return v.serialize();
	        }) : val.serialize();
	      });
	      ...
	      this.relationships.forEach(function (obs) {
	        var nname = obs.nestable_name;
	        var val = obs();
	        if (nname) json[nname] = obs.initial_length ? val.map(function (v) {
	          return v.serialize();
	        }) : val.serialize();
	      });
	      return json;
